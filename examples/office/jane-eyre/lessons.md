...
on `examples/office/jane-eyre/test/benchmark.json`, not estimated performance.
...
& $python .\examples\office\jane-eyre\tools\bold_docx_names.py `
    .\examples\office\jane-eyre\source\jane-eyre.docx `
    .\examples\office\jane-eyre\test\jane-eyre-main-characters-bold.docx

& $python .\examples\office\jane-eyre\tools\verify_bold_names.py `
    .\examples\office\jane-eyre\test\jane-eyre-main-characters-bold.docx `
    --original .\examples\office\jane-eyre\source\jane-eyre.docx
```
...
- `examples/office/jane-eyre/test/benchmark.json`: exact measurements and hashes.
- `examples/office/jane-eyre/test/jane-eyre-main-characters-bold.docx`: verified output.
