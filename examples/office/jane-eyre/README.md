...
```powershell
rg -n -i "red-room" .\examples\office\jane-eyre\projection\chapters
rg -l -i "St\. John" .\examples\office\jane-eyre\projection\chapters
rg -n '"kind":"chapter-heading"' .\examples\office\jane-eyre\projection\paragraphs.jsonl
```
...
```powershell
python .\examples\office\jane-eyre\tools\validate_analysis.py --write-build
```
